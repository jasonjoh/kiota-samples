...
namespace RepoStars.Client.Models {
    public class Repository_permissions : IAdditionalDataHolder, IParsable {
        ...
        /// <summary>
        /// Instantiates a new Repository_permissions and sets the default values.
        /// </summary>
        public Repository_permissions() {
