...
namespace RepoStars.Client.Models {
    public class Repository_template_repository_permissions : IAdditionalDataHolder, IParsable {
        ...
        /// <summary>
        /// Instantiates a new Repository_template_repository_permissions and sets the default values.
        /// </summary>
        public Repository_template_repository_permissions() {
